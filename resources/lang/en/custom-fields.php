...
return [
    ...
    'field' => [
        'form' => [
            ...
            'record' => [
                ...
                'unknown_entity' => 'Unregistered entity',
                'untitled_field' => 'Untitled field',
                'field_on_this_entity' => 'Field on this entity',
                'sync_banner' => 'Both fields read the same link: connect from either side and the other side shows it.',
                'sync_banner_symmetric' => 'One field read from both ends: every record it links to lists this record back.',
                'sync_banner_one_way' => 'One-way field: nothing is added to the related entity. Name a field below to show the link from the other side too.',
                'sentence_placeholder' => 'Pick a related entity to see how the two sides connect.',
                'sentence' => [
                    'one_to_one' => 'One :source links to one :target.',
                    'one_to_many' => 'One :source links to many :target.',
                    'many_to_one' => 'Many :source link to one :target.',
            ...
            'options' => [
                ...
                'paste_names_help' => 'Names only. A name you already have is skipped, and at most :max lines are read at once.',
                'paste_submit' => 'Add options',
                'pasted' => ':added added, :duplicates skipped as duplicates',
                'pasted_capped' => 'Only the first :max lines were read.',
            ],
            'advanced' => 'Advanced',
            'advanced_description' => 'The machine code other systems use to address this field. It is generated from the name.',
            'add_field' => 'Add Field',
    ...
    'field_type_descriptions' => [
        ...
        'record' => 'A one-way link to records of another entity.',
        'relationship' => 'A two-way link, with a matching field on the other entity.',
