...
# MySQL
mysql -u root -e "CREATE DATABASE custom_fields_test"
...
while PostgreSQL and MySQL workers raced against a single shared database and produced schema
collisions in testing. CI runs PostgreSQL and MySQL without `--parallel`.
